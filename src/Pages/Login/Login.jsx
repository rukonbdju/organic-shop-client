...
const Login = () => {
    const {user,signInWithGoogle,signInWithEmail}=useAuthInfo();
    ...
    return (
        <div className=" flex flex-col justify-center items-center my-16 max-w-full" >
            <div className="w-11/12 mx-auto max-w-xl">
                ...
                <button onClick={()=>signInWithGoogle()} className="w-full font-bold rounded-lg shadow-xl bg-gradient-to-r from-orange-500 to-orange-700 text-slate-100 px-4 uppercase py-2">continue with google</button>
                <p className="mt-4">
